      ...
      <div className="w-full max-w-md p-6 md:p-10 bg-white/90 rounded-xl shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            disabled={loading}
            type="submit"
            className="bg-red-800 text-white py-2 px-4 rounded-md hover:bg-red-600 uppercase items-center w-full"
          >
        ...
        <div className="mt-3 text-center">
          <p>
            ...
            <a href="/sign-up" className="text-red-800 hover:underline">
              {" "}
              Sign Up
            </a>
          </p>
