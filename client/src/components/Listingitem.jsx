...
export default function Listingitem({ listing }) {
  ...
  return (
    <div className="bg-white shadow-md shadow-red-800/40 rounded-lg overflow-hidden hover:shadow-lg hover:shadow-red-800/50 transition-shadow duration-300 w-full sm:w-[300px] mb-5">
